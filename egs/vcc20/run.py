...
if __name__ == "__main__":
    ...
    train_version  = "vcc20_train_24kHz"  # training
    valid_version  = "vcc20_valid_24kHz"  # validation
    eval_version   = "vcc20_eval_24kHz"   # evaluation
    ...
    config        = "conf/vcc20.%s.yaml" % (config_version)
